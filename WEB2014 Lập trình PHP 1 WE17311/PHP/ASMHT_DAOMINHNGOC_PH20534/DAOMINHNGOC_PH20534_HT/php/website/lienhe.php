...
<body>
    ...
    <nav class="">
        ...
        <div class="container">
            <div class="nav-main">
                ...
                <ul class="header-nav">
                    ...
                    <li><a href="lienhe.php" style="color: red;">Liên hệ</a></li>
        ...
        <!-- FORM đăng nhập -->
        <form class="can" action="./admin/lienhe/lienhe.php" method="post">
            <div class="chung">
        ...
        <?php if(isset($err_pass)) : ?>
            ...
            <div class="chung">
                <button class="bam" name="btn" type="submit">Gửi</button>
            </div>
        </form>
